...
public class RuntimeCommandTest {
    ...
    private Context context = new Context(new OutputStreamWriter(System.out));
    private ArrayList<String> args = new ArrayList<>();
    private ArrayList<Double> stack = context.getStack();
    ...
    public void addOK() throws CommandException {
        ...
        stack.add(3.0);
        add.exec(context);
        assertEquals((Double) 5.0, stack.get(stack.size() - 1));
    ...
    public void addUnderflowOne() throws CommandException {
        ...
        try {
            ...
            assertEquals((Double) 228.0, stack.get(stack.size() - 1));
            assertEquals(1, stack.size());
            throw e;
        }
    }
    ...
    public void addStackPersistence() throws CommandException {
        ...
        stack.add(2.0);
        add.exec(context);
        assertEquals((Double) 9.0, stack.get(stack.size() - 1));
        assertEquals((Double) 228.0, stack.get(stack.size() - 2));
    ...
    public void divideOK() throws CommandException {
        ...
        stack.add(4.0);
        divide.exec(context);
        assertEquals((Double) 2.0, stack.get(stack.size() - 1));
        assertEquals(1, stack.size());
    }
    ...
    public void divideByZero() throws CommandException {
        ...
        try {
            ...
            assertEquals((Double) 0.0, stack.get(stack.size() - 1));
            assertEquals((Double) 1.0, stack.get(stack.size() - 2));
            assertEquals(2, stack.size());
            throw e;
        }
    }
    ...
    public void multiplyOK() throws CommandException {
        ...
        assertEquals((Double) 32.0, stack.get(stack.size() - 1));
        assertEquals(1, stack.size());
    }
    ...
    public void subtractOK() throws CommandException {
        ...
        assertEquals((Double) 7.0, stack.get(stack.size() - 1));
        assertEquals(1, stack.size());
    }
    ...
    public void sqrtStackPersistence() throws CommandException {
        ...
        sqrt.exec(context);
        assertEquals((Double) 2.0, stack.get(stack.size() - 1));
        assertEquals((Double) 8.0, stack.get(stack.size() - 2));
    ...
    public void sqrtFromNegativeNumber() throws CommandException {
        ...
        try {
            ...
            assertEquals((Double) (-1.0), stack.get(stack.size() - 1));
            assertEquals(1, stack.size());
            throw e;
        }
    }
    ...
    public void defineOK() throws CommandException {
        ...
        define.exec(context);
        assertEquals((Double) 4.0, context.getAliases().get("a"));
    }
